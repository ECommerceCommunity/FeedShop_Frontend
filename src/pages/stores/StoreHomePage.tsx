  ...
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col bg-slate-50">
          ...
          <div className="p-6">
              ...
              <div className="bg-white rounded-lg shadow">
                <div className="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                  ...
                  <button
                    ...
                    onClick={() => {
                      alert(
                        "모든 인기 메뉴를 표시합니다. (여기에 실제 동작을 구현하세요)"
                      );
                    }}
                  >
                    모두 보기
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
              {brands.map((brand) => (
                <div
                  key={brand.store_id}
                  className="bg-white rounded-lg shadow p-6 relative flex flex-col justify-between"
                >
                  <div>
                    <div className="flex items-center mb-4">
                      <img
                        ...
                        className="bg-black rounded-md w-12 h-12 mr-4"
                      />
                      <div>
                        ...
                        <p className="text-sm text-gray-500">
                          {brand.brand_likes.toLocaleString()} likes
                        </p>
                      </div>
                    </div>
            ...
            <div className="bg-white rounded-lg shadow mb-8">
              ...
              <div className="p-6 space-y-6">
                {(showAllReviews ? reviews : reviews.slice(0, 10)).map(
                  (review) => (
                    <div
                      key={review.id}
        ...
        <div
          className={`fixed top-20 right-4 max-w-xs bg-white rounded-lg shadow-lg p-4 flex items-start z-50 transform transition-transform duration-300 ${
