...
![채팅 기능](https://via.placeholder.com/800x400/F59E0B/FFFFFF?text=Chat+Feature)
...
**포트폴리오**: [포트폴리오 링크](https://your-portfolio.com)
...
- Tailwind CSS 팀에게 아름다운 디자인 시스템을 제공해주셔서 감사합니다
- 모든 오픈소스 기여자들에게 감사합니다
